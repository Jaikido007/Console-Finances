...
// Setting console display text color to red in a function.
...
console.log(
	`${
		"Greatest Increase in Profits: " + dateOfGreatestIncrease
	} ($${greatestIncrease})`
);
console.log(
	`${
		"Greatest Decrease in Profits: " + dateOfGreatestDecrease
	} ($${greatestDecrease})`
);
